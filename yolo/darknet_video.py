...
video_rotate = 180
output_video_rate = 24
detect_score = 0.25
#YOLO

configPath = "models/yolov3/yolov3.cfg"
weightPath = "models/yolov3/weights/yolov3_33000.weights"
metaPath = "models/yolov3/obj.data"
...
def YOLO():
    ...
    cap = cv2.VideoCapture("videos/IMG_9518.MOV")
    cap.set(3, 1280)
    cap.set(4, 720)
    out = cv2.VideoWriter(
    ...
    while True:
        ...
        frame_read = imutils.rotate(frame_read, video_rotate)
